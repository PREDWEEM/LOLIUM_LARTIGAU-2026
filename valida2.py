# -*- coding: utf-8 -*-
# ===============================================================
# 🌾 PREDWEEM INTEGRAL vK4.9.10 — LOLIUM LARTIGAU 2026
# Actualización:
# - ADAPTACIÓN LARTIGAU: Coordenadas mantenidas estrictamente en -38.6166 para ET0.
...
def calcular_et0_hargreaves(jday, tmax, tmin, latitud=-38.6166):
    # Latitud ajustada para Lartigau (-38.6166)
...
if df_meteo_raw is not None and modelo_ann is not None:
    ...
    st.sidebar.download_button("📥 Descargar Reporte Completo", output.getvalue(), "PREDWEEM_Integral_Lartigau_vK4_9_10_clean.xlsx")

...
Antes de ejecutarla se aplica una capa auditable que incorpora el decaimiento
desde el 15 de abril y reemplaza la escala logarítmica del gráfico principal
por intensidad relativa de emergencia 0–100 %. Luego se agrega la descarga
Excel completa de los resultados generados.
"""

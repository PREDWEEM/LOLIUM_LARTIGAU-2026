...
# Actualización:
# - ADAPTACIÓN LARTIGAU: Latitud mantenida en -38.45 según solicitud.
...
# ---------------------------------------------------------
st.set_page_config(
    page_title="PREDWEEM LARTIGAU vK4.9.9",
    layout="wide",
    page_icon="🌾"
)
...
def load_data(file_uploader=None):
    ...
    github_url = "https://raw.githubusercontent.com/PREDWEEM/LOLIUM_LARTIGAU_2026/main/meteo_daily.csv"
    try:
...
st.sidebar.image(
    "https://raw.githubusercontent.com/PREDWEEM/LOLIUM_LARTIGAU_2026/main/logo.png",
...
if df_meteo_raw is not None and modelo_ann is not None:
    ...
    # -----------------------------------------------------
    st.title("🌾 PREDWEEM LOLIUM - LARTIGAU (MODELO ADAPTATIVO)")
    ...
    fig_risk.update_layout(height=120, margin=dict(t=30, b=0, l=10, r=10), title="Mapa de Riesgo Diario (Lartigau)")
    ...
    st.sidebar.download_button(
        ...
        output.getvalue(),
        "PREDWEEM_Operativo_Lartigau_vK4_9_9.xlsx"
    )

else:
    st.info("👋 Bienvenido a PREDWEEM LARTIGAU. El sistema está esperando los datos climáticos para comenzar y autocalibrarse.")

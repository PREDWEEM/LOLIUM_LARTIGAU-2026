...
# Actualización: Inicio de conteo desde el PRIMER pico + Precipitaciones (GitHub)
# ===============================================================
...
if df is not None and modelo_ann is not None:
    ...
    # TABS PRINCIPALES AHORA SON 4 (Añadida la pestaña de precipitaciones)
    ...
    # --- TAB 2: PRECIPITACIONES (Sólo Lluvia Diaria) ---
    with tab2:
